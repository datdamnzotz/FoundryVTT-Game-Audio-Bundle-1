...
`https://raw.githubusercontent.com/datdamnzotz/FoundryVTT-gdcAudioBundle-2016/master/module.json`
...
The Playlists will then show up under `Compendium Packs` prefixed with `gab-1-`
